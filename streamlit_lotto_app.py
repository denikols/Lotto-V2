...
if uploaded_file:
    ...
    # 👉 Visualizzazione dei numeri usciti + precedenti e successivi
    col1, col2 = st.columns(2)
    with col1:
        ruota_input = st.selectbox("Scegli la ruota iniziale", ruote, key="ruota_iniziale")
    with col2:
    ...
    st.markdown("## 🔎 Analisi Estrazione Selezionata")
    st.markdown(f"- **Ruota:** {ruota_input}")
    st.markdown(f"- **Data:** {data_estrazione.strftime('%d/%m/%Y')}")
