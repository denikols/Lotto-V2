...
st.title("💰 Simulazione Gioco - Ambo & Terno da data personalizzata (flessibile)")
...
if uploaded_file:
    ...
    conteggi = {
        "Terno": df_risultati["Esito"].str.contains("Terno").sum(),
        "Ambo su 2": df_risultati["Esito"].str.contains("Ambo su 2").sum(),
        "Ambo su 3": df_risultati["Esito"].str.contains("Ambo su 3").sum(),
        "Ambo su 4": df_risultati["Esito"].str.contains("Ambo su 4").sum()
    }
    ...
    st.markdown(f"- 🎯 **Terni Vinti:** {conteggi['Terno']}")
    st.markdown(f"- 🔸 **Ambi su 2:** {conteggi['Ambo su 2']}")
    st.markdown(f"- 🔹 **Ambi su 3:** {conteggi['Ambo su 3']}")
    st.markdown(f"- 🟦 **Ambi su 4:** {conteggi['Ambo su 4']}")
