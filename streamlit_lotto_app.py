...
if file_csv is not None:
    try:
        ...
        # Debug: mostra le colonne presenti nel DataFrame
        ...
        data_filtrata = df[df['Date'].dt.date == data_selezionata]
        ...
        # Mostra un esempio della struttura attesa
        st.write("Il file dovrebbe avere una colonna 'Date' e colonne per ogni ruota")
        if 'df' in locals():
            st.write("Prime righe del file caricato:")
            st.write(df.head())
