...
<span style='color:red; font-size:18px'><b>T</b></span>: Terno
    ...
    with col_estrazioni:
        ...
        with col_legenda:
            st.markdown("<span style='color:green'><b>Verde</b></span>: Estratti base", unsafe_allow_html=True)
            st.markdown("<span style='color:orange'><b>Arancione</b></span>: Precedenti/Successivi", unsafe_allow_html=True)
            st.markdown("<span style='color:red; font-size:18px'><b>A</b></span>: Ambo", unsafe_allow_html=True)
            st.markdown("<span style='color:red; font-size:18px'><b>T</b></span>: Terno", unsafe_allow_html=True)
