...
if uploaded_file:
    ...
    st.markdown("### 📊 Frequenza storica dei 15 numeri analizzati")
    ...
    styled_df = df_freq.style.applymap(lambda x: "", subset=["Presenze nei 5 colpi successivi"])
    styled_df = styled_df.apply(lambda row: [colore_numero(row)] * len(row), axis=1)
