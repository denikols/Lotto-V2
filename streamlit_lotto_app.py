...
if uploaded_file:
    ...
    with col1:
        ruota_input = st.selectbox("Scegli la ruota per il calcolo base", ruote)
    with col2:
    ...
    risultati_spia = []  # Inizializza risultati_spia al di fuori del blocco if
    if 'df' in locals() and 'numero_spia_input' in locals() and 'ruota_input' in locals() and 'finestra_analisi_spia' in locals():
