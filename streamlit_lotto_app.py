...
if uploaded_file:
    ...
    if st.button("📊 Analizza e scegli la ruota migliore"):
        ...
        st.markdown("st.markdown("""<span style='color:green'><b>Verde</b></span>: Estratti base<br>
...
<span style='color:red; font-size:18px'><b>T</b></span>: Terno""", unsafe_allow_html=True): Estratti base<br>
            <span style='color:orange'><b>Arancione</b></span>: Precedenti/Successivi<br>
            <span style='color:red; font-size:18px'><b>A</b></span>: Ambo<br>
