...
# Pulsante di stampa (posizione in alto a destra)
st.markdown("""
<div style="position: absolute; right: 10px; top: 10px; z-index: 1000;">
    <button onclick="window.print()" style="background-color: #4CAF50; color: white; padding: 8px 15px; border: none; border-radius: 4px; cursor: pointer;">
        🖨️ Stampa analisi
    </button>
</div>
""", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    # Aggiungi una intestazione di stampa (visibile solo durante la stampa)
    st.markdown("""
