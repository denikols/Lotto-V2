...
# Informazioni sul formato del file CSV nella sidebar
st.sidebar.header("Formato CSV richiesto")
st.sidebar.write("Il file CSV deve essere strutturato così:")
st.sidebar.code("""data,ruota,numero1,numero2,numero3,numero4,numero5
2024-01-01,bari,1,34,56,78,90
2024-01-01,roma,23,45,67,89,12""")

# Esempio di file CSV da scaricare
esempio_csv = """data,ruota,numero1,numero2,numero3,numero4,numero5
2024-01-01,bari,1,34,56,78,90
2024-01-01,roma,23,45,67,89,12"""

st.sidebar.download_button(
    label="Scarica file CSV di esempio",
    data=esempio_csv,
    file_name="esempio_lotto.csv",
    mime="text/csv"
)